...
class TestRoute(unittest.TestCase):
    ...
    def test_gps_tracker_service(self):
        """
    ...
    def _push_route(self, route_id):
        """
        adding waypoints from wgs84_coordinates
        """
    ...
    def test_get_unkown_route_id_length(self):
        """
        If the service receives a request for the length of unknown route_id,
        then return an error message without doing a full lookup in the db.
        """
    ...
    def test_calculate_longest_route_for_today(self):
        """
        Requests for route length will only query days in the past.
        Test that the service rejects attempts to query for
        the longest route on today's date.
        """
